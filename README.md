...
3. Gaming Setup (Disable Monitor 2 & Launch Steam)
...
4. Coding Setup (Portrait Mode + Desktop Shortcut)
Rotates Monitor 2 by 90 degrees, places it to the right of the primary, and creates a desktop shortcut.
displayflow.exe "1:3440:1440:0:0:1:0:144 2:1080:1920:3440:0:0:90:60" --save Dev --linkdesktop

5. Ultrawide Focus (Direct Link Hotkey)
